...
macro_rules! handler {
    () => {
        tauri::generate_handler![
            ...
            $crate::runtime_update_v2::runtime_update_status,
            $crate::runtime_update_v2::runtime_update_stage_candidate,
            $crate::runtime_update_v2::runtime_update_activate,
            $crate::runtime_update_v2::runtime_update_rollback,
            $crate::plugin_manager_v2::plugin_manager_status,
