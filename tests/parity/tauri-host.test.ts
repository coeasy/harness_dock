...
describe('Tauri v0.2 host contract', () => {
  ...
  it('keeps the Shell Settings plugin on demand while Harness Web is mandatory', () => {
    ...
    expect(shell).toContain("menuToggle.innerHTML = '菜单")
    expect(shell).toContain("menuToggle.setAttribute('aria-haspopup', 'menu')")
    expect(shell).toContain("button.setAttribute('role', 'menuitem')")
    expect(shell).toContain('打开 Harness 菜单')
